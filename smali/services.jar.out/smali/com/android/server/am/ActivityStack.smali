...
.field private mCurForeGroundAppPkg:Ljava/lang/String;
...
.method private checkAppNeedLocked(Ljava/lang/String;)V
    .locals 1
    .parameter "pkg"

    .prologue
    .line 1232
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->getZTEPrivacyManager()Lcom/zte/privacy/ZTEPrivacyManager;

    move-result-object v0

    .line 1233
    .local v0, mPrivacy:Lcom/zte/privacy/ZTEPrivacyManager;
    invoke-virtual {v0, p1}, Lcom/zte/privacy/ZTEPrivacyManager;->enforceAppLocked(Ljava/lang/String;)V
...
.method private final completeResumeLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/am/ActivityStack;->checkAppNeedLocked(Ljava/lang/String;)V
...
.method private foregroundAppCPUStatistics()V
    .locals 3
    ...
    .line 816
    :cond_1
    iget-object v0, p0, Lcom/android/server/am/ActivityStack;->mBatteryStatsImpl:Lcom/android/internal/os/BatteryStatsImpl;
    ...
    invoke-virtual {v0}, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->getBatteryStats()Lcom/android/internal/os/BatteryStatsImpl;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mBatteryStatsImpl:Lcom/android/internal/os/BatteryStatsImpl;

    .line 820
    :cond_2
    iget-object v0, p0, Lcom/android/server/am/ActivityStack;->mCurForeGroundAppPkg:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mCurForeGroundAppPkg:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mCurForeGroundAppPkg:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Lcom/android/internal/os/BatteryStatsImpl;->setForeGroundAppUid(ILjava/lang/String;)V

    goto :goto_0
.end method

.method private getZTEPrivacyManager()Lcom/zte/privacy/ZTEPrivacyManager;
    .locals 2

    .prologue
    .line 2523
    sget-object v0, Lcom/android/server/am/ActivityStack;->sPrivacyManager:Lcom/zte/privacy/ZTEPrivacyManager;
...
.method private isLimitLaunchApp(Landroid/content/Intent;)Z
    .locals 10
    .parameter "intent"
    ...
    const-string v9, "liutao>>> current App: "
    ...
    .line 2558
    .local v4, limitLaunchApps:[Ljava/lang/String;
    move-object v0, v4
    ...
    .line 2560
    .local v3, limitApp:Ljava/lang/String;
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    .line 783
    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->foregroundAppCPUStatistics()V
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    const-string v4, "persist.sys.battery.lowpower"
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/ActivityStack;->isLimitLaunchApp(Landroid/content/Intent;)Z

    move-result v21

    .line 2584
    .local v21, bLimitLaunch:Z
    ...
    const-string v7, "liutao>>> bLimitLaunch:"
    ...
    const-string v3, "zte.intent.action.LIMIT_LAUNCH_APP"
    ...
    .line 2588
    .local v29, intentTmp:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 2785
    .end local v21           #bLimitLaunch:Z
    .end local v29           #intentTmp:Landroid/content/Intent;
    :goto_0
    return v3
    ...
    .line 2610
    .local v20, appLaunchData:[I
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mPowerServiceClient:Lcom/nvidia/PowerServiceClient;

    const/4 v4, 0x4

    move-object/from16 v0, v20

    invoke-virtual {v3, v4, v0}, Lcom/nvidia/PowerServiceClient;->sendPowerHint(I[I)V
    ...
    .line 2612
    .restart local v20       #appLaunchData:[I
    :cond_5
    const/16 v35, 0x0
