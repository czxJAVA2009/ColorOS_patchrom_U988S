...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/BatteryService$MaxBackLight;,
...
.field private mAppProfileService:Lcom/nvidia/NvAppProfileService;
...
.field private mMaxBacklight:Lcom/android/server/BatteryService$MaxBackLight;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 185
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->mLowPowerMode:Z
    ...
    invoke-direct {v1, p1}, Lcom/nvidia/NvAppProfileService;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/android/server/BatteryService;->mAppProfileService:Lcom/nvidia/NvAppProfileService;
    ...
    iput-object v1, p0, Lcom/android/server/BatteryService;->mPhone:Landroid/telephony/TelephonyManager;

    .line 205
    new-instance v1, Lcom/android/server/BatteryService$MaxBackLight;

    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/BatteryService$MaxBackLight;-><init>(Lcom/android/server/BatteryService;Landroid/content/Context;Lcom/android/server/LightsService;)V

    iput-object v1, p0, Lcom/android/server/BatteryService;->mMaxBacklight:Lcom/android/server/BatteryService$MaxBackLight;
    ...
    iput v1, p0, Lcom/android/server/BatteryService;->mLowBatteryLedWarningLevel:I
    ...
    .line 234
    .local v0, quibootfilter:Landroid/content/IntentFilter;
    const-string v1, "com.android.deskclock.ALARM_SET_NEXT"
    ...
    .line 231
    .end local v0           #quibootfilter:Landroid/content/IntentFilter;
    :catchall_0
    move-exception v1
...
.method private processValuesLocked()V
    ...
    :goto_7
    invoke-direct {p0}, Lcom/android/server/BatteryService;->turnToLowPowerModeForProfile()Z
    ...
    .line 518
    iget-object v0, p0, Lcom/android/server/BatteryService;->mAppProfileService:Lcom/nvidia/NvAppProfileService;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/nvidia/NvAppProfileService;->updatePowerModeAutoSwitch(Z)V

    .line 523
    :cond_8
    :goto_8
    invoke-direct {p0}, Lcom/android/server/BatteryService;->turnToLowPowerModeForOthers()Z
    ...
    iput-boolean v0, p0, Lcom/android/server/BatteryService;->mLowPowerMode:Z

    .line 525
    iget-object v0, p0, Lcom/android/server/BatteryService;->mPhone:Landroid/telephony/TelephonyManager;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/telephony/TelephonyManager;->setGsmOnlyForce(Z)Z

    .line 526
    iget-object v0, p0, Lcom/android/server/BatteryService;->mMaxBacklight:Lcom/android/server/BatteryService$MaxBackLight;

    const/16 v1, 0x80

    invoke-virtual {v0, v1}, Lcom/android/server/BatteryService$MaxBackLight;->setMaxBackLight(I)V

    .line 527
    const/4 v0, 0x0

    invoke-static {v0}, Landroid/hardware/Camera;->enableFlash(Z)I
    ...
    :cond_17
    invoke-direct {p0}, Lcom/android/server/BatteryService;->resumeUserSettingsForProfile()Z
    ...
    .line 528
    :cond_18
    invoke-direct {p0}, Lcom/android/server/BatteryService;->resumeUserSettingsForOthers()Z
...
.method private resumeUserSettingsForOthers()Z
    .locals 3
    ...
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mLowPowerMode:Z
...
.method private resumeUserSettingsForProfile()Z
    .locals 3
    ...
    invoke-virtual {v0}, Lcom/nvidia/NvAppProfileService;->isLowPowerMode()Z
...
.method private turnToLowPowerModeForOthers()Z
    .locals 3
...
.method private turnToLowPowerModeForProfile()Z
    .locals 3
...
.method public writeForLowPowerCharging()V
    .locals 5
