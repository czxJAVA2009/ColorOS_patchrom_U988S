...
# static fields
.field private static final ACTION_ALARMSERVICE_QUICKBOOT:Ljava/lang/String; = "android.intent.alarm.quickboot"

.field public static final ACTION_ALARM_SHUT_DOWN:Ljava/lang/String; = "android.intent.action.ACTION_ALARM_SHUT_DOWN"
...
.field static mQuickBootUpAnim:Z
...
.field public static mWifiDisplayConnected:Z
...
# instance fields
.field eventCamera:Landroid/view/KeyEvent;
...
.field mCameraWakeLock:Landroid/os/PowerManager$WakeLock;
...
.field private mIsScreenOnNeedDelay:Z

.field private mKeyPowerTimePre:J
...
.field mQuitBootWakeLock2:Landroid/os/PowerManager$WakeLock;
...
.field private final mStopQuickbootAnim:Ljava/lang/Runnable;

.field private final mStopQuickbootAnim2:Ljava/lang/Runnable;
...
.field mWFDReceiver:Landroid/content/BroadcastReceiver;
...
.method static constructor <clinit>()V
    ...
    .line 211
    sput-boolean v3, Lcom/android/internal/policy/impl/PhoneWindowManager;->mQuickBootUpAnim:Z

    .line 212
    sput-boolean v3, Lcom/android/internal/policy/impl/PhoneWindowManager;->bPlugIn:Z

    .line 224
    sput v3, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFullScreenSend:I
    ...
    .line 534
    sput-boolean v3, Lcom/android/internal/policy/impl/PhoneWindowManager;->mWifiDisplayConnected:Z
...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyPowerTimePre:J

    .line 538
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIsScreenOnNeedDelay:Z
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStopQuickbootAnim2:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStopQuickbootAnim:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mWFDReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$1000(Lcom/android/internal/policy/impl/PhoneWindowManager;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$200(Lcom/android/internal/policy/impl/PhoneWindowManager;)V
    ...
    .prologue
    .line 175
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->quickBootComplete()V
...
.method static synthetic access$300(Lcom/android/internal/policy/impl/PhoneWindowManager;)Ljava/lang/Runnable;
    ...
    .prologue
    .line 175
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStopQuickbootAnim2:Ljava/lang/Runnable;

    return-object v0
.end method

.method static synthetic access$400(Lcom/android/internal/policy/impl/PhoneWindowManager;)Ljava/lang/Runnable;
    .locals 1
    .parameter "x0"

    .prologue
    .line 175
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStopQuickbootAnim:Ljava/lang/Runnable;
...
.method static synthetic access$800(Lcom/android/internal/policy/impl/PhoneWindowManager;)V
    ...
    .prologue
    .line 175
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->resetAirplaneModeSet()V
...
.method static synthetic access$900()Z
    ...
    .prologue
    .line 175
    sget-boolean v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->bPlugIn:Z
...
.method private interceptCameraKeyDown(Z)V
    .locals 4
    .parameter "handled"
    ...
    const-string v1, "  interceptCameraKeyDown"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iput-boolean p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCameraKeyHandled:Z
...
.method private interceptCameraKeyUp(Z)Z
    .locals 3
    .parameter "canceled"
    ...
    iget-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCameraKeyHandled:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHandler:Landroid/os/Handler;

    iget-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCameraLongPress:Ljava/lang/Runnable;
...
.method private resetAirplaneModeSet()V
    ...
    const-string v12, "persist_sys_qbGpsWasOn"
    ...
    const-string v13, "QuickBoot DOWN Start init, gpsEnabled="
    ...
    invoke-static {v6, v11, v3}, Landroid/provider/Settings$Secure;->setLocationProviderEnabled(Landroid/content/ContentResolver;Ljava/lang/String;Z)V
    ...
    .local v7, wifi:Landroid/net/wifi/IWifiManager;
    iget-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mContext:Landroid/content/Context;
    ...
    const-string v12, "persist_sys_qbwifiWasOn"

    invoke-static {v11, v12, v10}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v8

    .local v8, wifiWasOn:I
    if-eqz v7, :cond_1
    ...
    :try_start_0
    invoke-interface {v7, v11}, Landroid/net/wifi/IWifiManager;->setWifiEnabled(Z)Z
    :try_end_0
    ...
    const-string v13, "QuickBoot UP Start, wifiWasOn="
    ...
    const-string v12, "persist_sys_qbbtWasOn"
    ...
    const-string v13, "QuickBoot UP Start, bluetoothWasOn111="
    ...
    const-string v13, "QuickBoot UP Start, bluetoothWasOn="
    ...
    const-string v12, "QuickBoot UP Start, airplanemode="
    ...
    invoke-interface {v4, v9}, Lcom/android/internal/telephony/ITelephony;->setRadio(Z)Z
    :try_end_2
    ...
    .end local v0           #bluetooth:Landroid/bluetooth/IBluetoothManager;
    .end local v1           #bluetoothWasOn:I
    .end local v3           #gpsEnabled:Z
    .end local v4           #phone:Lcom/android/internal/telephony/ITelephony;
    .end local v5           #radioChannel:I
    .end local v7           #wifi:Landroid/net/wifi/IWifiManager;
    .end local v8           #wifiWasOn:I
    :cond_4
    move v3, v10

    goto/16 :goto_0

    .restart local v0       #bluetooth:Landroid/bluetooth/IBluetoothManager;
    .restart local v1       #bluetoothWasOn:I
    .restart local v3       #gpsEnabled:Z
    .restart local v4       #phone:Lcom/android/internal/telephony/ITelephony;
    .restart local v5       #radioChannel:I
    .restart local v7       #wifi:Landroid/net/wifi/IWifiManager;
    .restart local v8       #wifiWasOn:I
    :catch_0
    move-exception v2
    ...
    const-string v10, "RemoteException during radio restore"
...
.method updateSystemUiVisibilityLw()I
    ...
    new-instance v5, Lcom/android/internal/policy/impl/PhoneWindowManager$26;

    invoke-direct {v5, p0, v3, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager$26;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;IZ)V
...
.method public finishPostLayoutPolicyLw()I
    ...
    sput v8, Lcom/android/internal/policy/impl/PhoneWindowManager;->mFullScreenSend:I
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    new-instance v3, Lcom/android/internal/policy/impl/keyguard/OppoKeyguardViewMediator;

    invoke-direct {v3, p1, v6}, Lcom/android/internal/policy/impl/keyguard/OppoKeyguardViewMediator;-><init>(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)V

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardMediator:Lcom/android/internal/policy/impl/keyguard/OppoKeyguardViewMediator;

    :cond_0
    new-instance v3, Lcom/android/internal/policy/impl/PhoneWindowManager$PolicyHandler;

    invoke-direct {v3, p0, v6}, Lcom/android/internal/policy/impl/PhoneWindowManager$PolicyHandler;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Lcom/android/internal/policy/impl/PhoneWindowManager$1;)V
    ...
    invoke-direct {v3, p0, v4}, Lcom/android/internal/policy/impl/PhoneWindowManager$MyOrientationListener;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/policy/impl/PhoneWindowManager$MyOrientationListener;->setCurrentRotation(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v3, p1, v4}, Lcom/android/internal/policy/impl/ShortcutManager;-><init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    const-string v4, "PhoneWindowManager.mQuitBootWakeLock"

    invoke-virtual {v3, v10, v4}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v3

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mQuitBootWakeLock:Landroid/os/PowerManager$WakeLock;

    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerManager:Landroid/os/PowerManager;

    const-string v4, "PhoneWindowManager.mQuitBootWakeLock2"

    invoke-virtual {v3, v9, v4}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v3

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mQuitBootWakeLock2:Landroid/os/PowerManager$WakeLock;

    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerManager:Landroid/os/PowerManager;

    const-string v4, "PhoneWindowManager.mCameraWakeLock"

    invoke-virtual {v3, v10, v4}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v3

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCameraWakeLock:Landroid/os/PowerManager$WakeLock;

    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCameraWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    .restart local v0       #filter:Landroid/content/IntentFilter;
    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mWFDReceiver:Landroid/content/BroadcastReceiver;
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    invoke-virtual {v3, v5}, Landroid/os/PowerManager;->requestButtonLedState(Z)V
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    iput-object v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->eventCamera:Landroid/view/KeyEvent;
    ...
    const-string v20, "persist.sys.quickboot"
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/os/PowerManager;->getQuickBootMode()I

    move-result v16

    .local v16, quickboot_state:I
    const-string v20, "WindowManager"
    ...
    const-string v22, "QuickBoot UP Press quickbootVal="
    ...
    const-string v22, "  quickboot_state="
    ...
    sget-boolean v20, Lcom/android/internal/policy/impl/PhoneWindowManager;->mQuickBootUpAnim:Z
    ...
    const-string v21, "QuickBoot UP Animation"
    ...
    .end local v15           #quickbootVal:I
    .end local v16           #quickboot_state:I
    :cond_4
    const/4 v6, 0x0
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/policy/impl/keyguard/OppoKeyguardViewMediator;->isShowingAndNotHidden()Z
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/policy/impl/keyguard/OppoKeyguardViewMediator;->isShowing()Z
    ...
    .restart local v15       #quickbootVal:I
    .restart local v16       #quickboot_state:I
    :cond_9
    const/16 v20, 0x1
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptCameraKeyDown(Z)V
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptCameraKeyUp(Z)Z
    ...
    .local v4, amManager:Landroid/app/ActivityManager;
    const/16 v20, 0x1
    ...
    .local v18, runningTask:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningTaskInfo;>;"
    const/4 v9, 0x0

    .local v9, isAnyCameraRunning:Z
    if-eqz v18, :cond_21
    ...
    iput-boolean v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIsScreenOnNeedDelay:Z
    ...
    iput-wide v0, v2, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyPowerTimePre:J

    .end local v4           #amManager:Landroid/app/ActivityManager;
    .end local v9           #isAnyCameraRunning:Z
    .end local v18           #runningTask:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningTaskInfo;>;"
    :cond_22
    if-nez p3, :cond_23

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIsScreenOnNeedDelay:Z
    ...
    iget-wide v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyPowerTimePre:J
    ...
    .end local v8           #hungUp:Z
    .end local v19           #telephonyService:Lcom/android/internal/telephony/ITelephony;
    .restart local v4       #amManager:Landroid/app/ActivityManager;
    .restart local v9       #isAnyCameraRunning:Z
    .restart local v18       #runningTask:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningTaskInfo;>;"
    :cond_26
    const/4 v9, 0x0
