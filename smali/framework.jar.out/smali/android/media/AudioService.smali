...
.field private static LBH_ID_PROPERTY:Ljava/lang/String; = null

.field private static LBH_ID_PROPERTY_DEFAULT:Ljava/lang/String; = null
...
.field private static final SOUND_EFFECTS_PATH_LBH:Ljava/lang/String; = "/lbh/media/audio/ui/"
...
.method static constructor <clinit>()V
    ...
    .line 209
    const-string/jumbo v0, "ro.nvidia.lbh_id"

    sput-object v0, Landroid/media/AudioService;->LBH_ID_PROPERTY:Ljava/lang/String;

    .line 210
    const-string v0, "0000"

    sput-object v0, Landroid/media/AudioService;->LBH_ID_PROPERTY_DEFAULT:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Landroid/media/AudioService;->mHeadseton:Z
...
.method static synthetic access$8900(Landroid/media/AudioService;Landroid/os/IBinder;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$9300(Landroid/media/AudioService;)Ljava/util/Stack;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9402(Landroid/media/AudioService;Landroid/media/IRemoteControlDisplay;)Landroid/media/IRemoteControlDisplay;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method public adjustStreamVolume(III)V
    ...
    iget-object v5, v0, Landroid/media/AudioService;->mKeyguardManager:Landroid/app/KeyguardManager;
...
.method public loadSoundEffects()Z
    ...
    iget-object v13, v0, Landroid/media/AudioService;->mSoundEffectsLock:Ljava/lang/Object;
    ...
    iget-boolean v12, v0, Landroid/media/AudioService;->mBootCompleted:Z

    if-nez v12, :cond_0

    const-string v12, "AudioService"

    const-string v14, "loadSoundEffects() called before boot complete"
    ...
    iget-object v12, v0, Landroid/media/AudioService;->mSoundPool:Landroid/media/SoundPool;
    ...
    invoke-direct {v12, v14, v15, v0}, Landroid/media/SoundPool;-><init>(III)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/media/AudioService;->mSoundPool:Landroid/media/SoundPool;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iput-object v12, v0, Landroid/media/AudioService;->mSoundPoolCallBack:Landroid/media/AudioService$SoundPoolCallback;

    new-instance v12, Landroid/media/AudioService$SoundPoolListenerThread;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Landroid/media/AudioService$SoundPoolListenerThread;-><init>(Landroid/media/AudioService;)V

    move-object/from16 v0, p0

    iput-object v12, v0, Landroid/media/AudioService;->mSoundPoolListenerThread:Landroid/media/AudioService$SoundPoolListenerThread;

    move-object/from16 v0, p0

    iget-object v12, v0, Landroid/media/AudioService;->mSoundPoolListenerThread:Landroid/media/AudioService$SoundPoolListenerThread;

    invoke-virtual {v12}, Landroid/media/AudioService$SoundPoolListenerThread;->start()V

    move-object/from16 v0, p0

    iget-object v12, v0, Landroid/media/AudioService;->mSoundEffectsLock:Ljava/lang/Object;
    ...
    iget-object v12, v0, Landroid/media/AudioService;->mSoundPoolCallBack:Landroid/media/AudioService$SoundPoolCallback;

    if-nez v12, :cond_3

    const-string v12, "AudioService"

    const-string v14, "loadSoundEffects() could not create SoundPool listener or thread"

    invoke-static {v12, v14}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    move-object/from16 v0, p0

    iget-object v12, v0, Landroid/media/AudioService;->mSoundPoolLooper:Landroid/os/Looper;
    ...
    iput-object v12, v0, Landroid/media/AudioService;->mSoundPoolLooper:Landroid/os/Looper;
    ...
    invoke-virtual {v12}, Landroid/media/SoundPool;->release()V
    ...
    const-string v14, "Interrupted while waiting sound pool listener thread."
    ...
    :cond_3
    sget-object v12, Landroid/media/AudioService;->SOUND_EFFECT_FILES:[Ljava/lang/String;
    ...
    iget-object v12, v0, Landroid/media/AudioService;->SOUND_EFFECT_FILES_MAP:[[I
    ...
    sget-object v12, Landroid/media/AudioService;->LBH_ID_PROPERTY:Ljava/lang/String;
    ...
    .local v7, lbh_id:Ljava/lang/String;
    const-string v12, ""
    ...
    sget-object v12, Landroid/media/AudioService;->LBH_ID_PROPERTY_DEFAULT:Ljava/lang/String;
    ...
    const-string v14, "/lbh/media/audio/ui/"

    invoke-virtual {v12, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    sget-object v14, Landroid/media/AudioService;->SOUND_EFFECT_FILES:[Ljava/lang/String;

    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/media/AudioService;->SOUND_EFFECT_FILES_MAP:[[I
    ...
    .local v5, filePath_lbh:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v12, v5, v14}, Landroid/media/SoundPool;->load(Ljava/lang/String;I)I

    move-result v10

    .local v10, sampleId_lbh:I
    if-gtz v10, :cond_7
    ...
    const-string v15, "Soundpool could not load file from LBH: "
    ...
    invoke-virtual {v12, v4, v14}, Landroid/media/SoundPool;->load(Ljava/lang/String;I)I
    ...
    .end local v5           #filePath_lbh:Ljava/lang/String;
    .end local v10           #sampleId_lbh:I
    :cond_8
    new-instance v12, Ljava/lang/StringBuilder;
    ...
    .end local v4           #filePath:Ljava/lang/String;
    .end local v7           #lbh_id:Ljava/lang/String;
    .end local v9           #sampleId:I
    :cond_a
    move-object/from16 v0, p0
    ...
    invoke-virtual {v12, v6}, Landroid/media/AudioService$SoundPoolCallback;->setLastSample(I)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    invoke-virtual {v12}, Landroid/media/AudioService$SoundPoolCallback;->status()I
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    const-string v15, "loadSoundEffects(), Error "
    ...
    const-string v15, " while loading samples"
...
.method public setStreamVolume(III)V
    ...
    const-string v0, "AudioService.java"

    const-string v1, "liying, STREAM_FM == true , ACTION_SETFMVOL"
