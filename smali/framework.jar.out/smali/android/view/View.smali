...
.method private dispatchMotionEventDefaultProcessBySmartPowerManager(Landroid/view/MotionEvent;)V
    .locals 8
    .parameter "event"
    ...
    sput-wide v2, Landroid/view/ViewRootImpl;->mGestureStartTime:J
    ...
    sget-wide v4, Landroid/view/ViewRootImpl;->mGestureStartTime:J
    ...
    sget-boolean v2, Landroid/view/ViewRootImpl;->haveMoveOut:Z

    if-eq v2, v6, :cond_2

    .line 7300
    sput v7, Landroid/view/ViewRootImpl;->interactiveType:I

    .line 7301
    const-string v2, "GYP POWER DEBUG:"

    const-string v3, "(long)click treat as WAITTING_MODE!!!"
    ...
    invoke-virtual {v2, v3}, Landroid/view/ViewRootImpl;->setTargetViewId(I)V

    goto :goto_0

    .line 7303
    :cond_2
    sput v6, Landroid/view/ViewRootImpl;->interactiveType:I

    .line 7304
    const-string v2, "GYP POWER DEBUG:"

    const-string/jumbo v3, "slip treat as READING_MODE!!!"
    ...
    iget v4, p0, Landroid/view/View;->mTouchSlop:I

    int-to-float v4, v4

    invoke-direct {p0, v2, v3, v4}, Landroid/view/View;->pointInView(FFF)Z
    ...
    .line 7313
    sput-boolean v6, Landroid/view/ViewRootImpl;->haveMoveOut:Z

    goto :goto_0

    .line 7315
    :cond_4
    sput-boolean v7, Landroid/view/ViewRootImpl;->haveMoveOut:Z
...
.method public dispatchGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 7337
    invoke-direct {p0, p1}, Landroid/view/View;->dispatchMotionEventDefaultProcessBySmartPowerManager(Landroid/view/MotionEvent;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    const-string v8, "(long)click treat as WAITTING_MODE!!!"
    ...
    invoke-virtual {v6, v8}, Landroid/view/ViewRootImpl;->setTargetViewId(I)V
    ...
    const-string/jumbo v8, "slip treat as READING_MODE!!!"
