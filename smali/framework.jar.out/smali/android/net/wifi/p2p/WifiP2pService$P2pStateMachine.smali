...
.method static synthetic access$7500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pConfig;)Z
    ...
    .prologue
    .line 361
    invoke-direct {p0, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->p2pConnectWithPinDisplay(Landroid/net/wifi/p2p/WifiP2pConfig;)Z
...
.method static synthetic access$7900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$8700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$GroupCreatedState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$8900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$FrequencyConflictState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;ILjava/lang/String;Z)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private connect(Landroid/net/wifi/p2p/WifiP2pConfig;Z)I
    ...
    invoke-virtual {v8, v3, v9}, Landroid/net/wifi/WifiNative;->p2pReinvoke(ILjava/lang/String;)Z
...
.method private handleGroupCreationFailure()V
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mConnectionUserReject:Ljava/lang/Boolean;
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$7300(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/lang/Boolean;
    ...
    const-string v2, "ConnectionUserReject"
    ...
    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mConnectionUserReject:Ljava/lang/Boolean;
    invoke-static {v0, v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$7302(Landroid/net/wifi/p2p/WifiP2pService;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mPinEntryDialog:Landroid/app/AlertDialog;
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$12000(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/app/AlertDialog;
    ...
    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mServiceDiscReqId:Ljava/lang/String;
    invoke-static {v0, v3}, Landroid/net/wifi/p2p/WifiP2pService;->access$5602(Landroid/net/wifi/p2p/WifiP2pService;Ljava/lang/String;)Ljava/lang/String;
...
.method private handleGroupRemoved()V
    ...
    invoke-virtual {p0, v5}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->sendMessage(I)V
...
.method private isWFDConnectionChanged()Z
    .locals 4
    ...
    .line 1826
    .restart local v0       #group:Landroid/net/wifi/p2p/WifiP2pGroup;
    :cond_2
...
.method private notifyInvitationReceived()V
    ...
    invoke-direct {v8, p0, v4, v1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$4;-><init>(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/WpsInfo;Landroid/widget/EditText;)V
    ...
    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mPinEntryDialog:Landroid/app/AlertDialog;
    invoke-static {v5, v6}, Landroid/net/wifi/p2p/WifiP2pService;->access$12002(Landroid/net/wifi/p2p/WifiP2pService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mPinEntryDialog:Landroid/app/AlertDialog;
    invoke-static {v5}, Landroid/net/wifi/p2p/WifiP2pService;->access$12000(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/app/AlertDialog;
...
.method private p2pConnectWithPinDisplay(Landroid/net/wifi/p2p/WifiP2pConfig;)Z
    .locals 5
    .parameter "config"
    ...
    invoke-virtual {v3, p1, v4}, Landroid/net/wifi/WifiNative;->p2pConnect(Landroid/net/wifi/p2p/WifiP2pConfig;Z)Ljava/lang/String;
...
.method private sendP2pConnectionChangedBroadcast()V
    ...
    .line 1839
    const-string/jumbo v1, "wifip2pWfdInfo"

    invoke-direct {p0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->isWFDConnectionChanged()Z
