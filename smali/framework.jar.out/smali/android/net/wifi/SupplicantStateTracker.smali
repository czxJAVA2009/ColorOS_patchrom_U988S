...
.field private static final DEF_LOOP_INDEX:I = 0x64
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfigStore;Landroid/os/Handler;)V
    ...
    iput v0, p0, Landroid/net/wifi/SupplicantStateTracker;->mLoopDetectIndex:I

    .line 64
    iput v2, p0, Landroid/net/wifi/SupplicantStateTracker;->mLoopDetectCount:I
...
.method static synthetic access$300(Landroid/net/wifi/SupplicantStateTracker;Landroid/net/wifi/StateChangeResult;Landroid/os/Message;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 37
    invoke-direct {p0, p1, p2}, Landroid/net/wifi/SupplicantStateTracker;->transitionOnSupplicantStateChange(Landroid/net/wifi/StateChangeResult;Landroid/os/Message;)V
...
.method private transitionOnSupplicantStateChange(Landroid/net/wifi/StateChangeResult;Landroid/os/Message;)V
    .locals 4
    ...
    .line 125
    :pswitch_3
    invoke-virtual {p0, p2}, Landroid/net/wifi/SupplicantStateTracker;->deferMessage(Landroid/os/Message;)V
