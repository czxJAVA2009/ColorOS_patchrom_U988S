...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    ...
    const-string/jumbo v24, "psk_key_type"
    ...
    const-string/jumbo v24, "wapi_as_cert"
    ...
    const-string/jumbo v24, "wapi_user_cert"
    ...
    const-string/jumbo v24, "pairwise"
    ...
    const-string/jumbo v24, "wep_tx_keyidx"
    ...
    const-string/jumbo v25, "scan_ssid"
    ...
    .line 1281
    .local v18, ret:Ljava/lang/Integer;
    if-eqz v18, :cond_1e
    ...
    .end local v18           #ret:Ljava/lang/Integer;
    :catchall_0
    move-exception v23
...
.method enableAllNetworks()V
    ...
    invoke-virtual {v3, v5, v6}, Landroid/net/wifi/WifiNative;->enableNetwork(IZ)Z
    ...
    .line 205
    .end local v1           #i$:Ljava/util/Iterator;
    .end local v2           #networkEnabledStateChanged:Z
    :cond_3
    return-void
.end method
...
.method loadConfiguredNetworks()V
    ...
    iput v8, p0, Landroid/net/wifi/WifiConfigStore;->mLastPriority:I

    .line 651
    iget-object v8, p0, Landroid/net/wifi/WifiConfigStore;->mConfiguredNetworks:Ljava/util/HashMap;
    ...
    iget v9, p0, Landroid/net/wifi/WifiConfigStore;->mLastPriority:I
    ...
    invoke-virtual {v7, v9}, Landroid/net/wifi/WifiNative;->removeNetwork(I)Z
